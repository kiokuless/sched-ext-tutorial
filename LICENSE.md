...
Copyright 2026 Kiokuless and contributors.

The SPDX license identifier in each source file or package manifest is authoritative for that file.
See `src/appendix/licenses.md` for provenance and links to the complete license texts.
